...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_shopUserName.setText("装修公司账号：" + mData.get(position).get("shopUserName").toString());
	  holder.tv_shopName.setText("装修公司名称：" + mData.get(position).get("shopName").toString());
	  holder.tv_washClassObj.setText("装修公司种类：" + (new WashClassService()).GetWashClass(Integer.parseInt(mData.get(position).get("washClassObj").toString())).getClassName());
	  ...
	  holder.tv_telephone.setText("装修公司电话：" + mData.get(position).get("telephone").toString());
