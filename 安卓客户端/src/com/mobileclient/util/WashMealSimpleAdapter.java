...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  /*设置各个控件的展示内容*/
	  holder.tv_mealName.setText("装修套餐：" + mData.get(position).get("mealName").toString());
	  ...
	  holder.tv_washShopObj.setText("装修公司：" + (new WashShopService()).GetWashShop(mData.get(position).get("washShopObj").toString()).getShopName());
