			...
			public void onClick(View v) {
				try {
					...
					if(ET_shopName.getText().toString().equals("")) {
						Toast.makeText(WashShopEditActivity.this, "装修公司名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(WashShopEditActivity.this, "装修公司电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传装修公司信息*/
					WashShopEditActivity.this.setTitle("正在更新装修公司信息，稍等...");
